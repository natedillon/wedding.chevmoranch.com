...
$script_path = 'http://wedding.chevmoranch.com/contact/contact-dd-formmailer.php';
...
$path_contact_page = 'http://wedding.chevmoranch.com/contact/index.php';
...
$form_struct = '
	type=openfieldset
		type=text|class=form-text|label=Name|fieldname=contact-name|max=100|req=true
		type=halfblock|class=form-halfblock form-spacer|text=<p></p>
		type=text|class=form-text|label=E-mail|fieldname=contact-email|max=100|req=true|ver=email
	type=closefieldset

	type=openfieldset
		type=textarea|class=form-textarea|label=Message|fieldname=contact-message|max=2000|rows=6|req=true
	type=closefieldset
';
...
$email_subject = 'Message from Wedding.ChevmoRanch.com';
